#!/usr/bin/env python3
"""
TLS Message Capture Tool (Python)
Captures TLS messages by proxying between client and server
"""
...
class TLSCapture:
    ...
    def start(self, output_filename='tls_all_messages.txt'):
...
if __name__ == '__main__':
    ...
    capture = TLSCapture(listen_port=proxy_port, server_port=server_port)
    capture.start()
